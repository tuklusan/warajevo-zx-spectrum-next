...
443. [P16][Core §43] Establish performance baselines for CPU execution, raster generation, audio mixing, tape, snapshots, and UI presentation before optimization — original pre-optimization baselines were captured on `574714b` (run `35886051010`); the accepted raster optimization was recalibrated on `3501819` (run `35888370795`); after correcting 48K frame coordinates and border-event rendering, four-runner baselines were refreshed on `b509ee8` (run `35936294325`), with prior records retained in Git history.
...
450. [FINAL][Core §50][AUDITED; gaps remain] Inventory all 75 criteria and record conservative evidence status in [acceptance-evidence-audit.md](acceptance-evidence-audit.md); 8 PASS, 11 PARTIAL, and 56 OPEN. The audit is complete; architecture completion remains gated on resolving the OPEN criteria.
...
455. [FINAL][Core §§36–40][AUDITED; gate open] Deterministic, video, audio, differential, private-media, and hardware evidence remains incomplete as recorded in [final release-readiness audit](final-release-readiness-audit.md) and the criterion audits. Hosted canonical regressions cover recurring 48K PAL ULA fetch/floating-bus timings (run `35938824266`, source `115e742`) and timestamped border changes with active-pixel preservation (run `35937597748`, source `658d2e5`); Core criteria 15, 17, 18, and 20 are PARTIAL pending broader frame and hardware evidence.
...
460. [FINAL][Core §49][UI §§49–50][AUDITED; gate open] The core audit records 8 PASS, 11 PARTIAL, and 56 OPEN criteria; the UI audit records 0 PASS, 7 PARTIAL, and 60 OPEN. Tasks 452–453 and 455–457 retain implementation, evidence, or release-gate gaps. See [final release-readiness audit](final-release-readiness-audit.md), [acceptance-evidence-audit.md](acceptance-evidence-audit.md), and [ui-acceptance-evidence-audit.md](ui-acceptance-evidence-audit.md).
