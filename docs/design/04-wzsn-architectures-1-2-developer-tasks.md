...
457. [FINAL][Core §§28.7][UI §44.1][COMPLETE] Deterministic multi-process stress passed all five cases on Windows x64/ARM64 and macOS Intel/ARM64 in hosted run `35923355250` at `3b5266b093759327ce8ec2ba2358266704a77b55`; pinned proof: [multi-instance-stress.json](../../test-results/multi-instance-stress.json).
458. [FINAL][Core §§30,55][UI §§4,40,46][PARTIAL; gate open] A four-runner hosted acceptance proves direct test, toolbar, and Telnet projections share registry dispatch and rejects wrong-thread mutation (`35928320513`, source `8d5003419b72c3ee53b359d9a6e2dba4f9c86502`, proof in `test-results/application-command-boundary.json`). Actual GUI menu-event projection and before/after canonical machine-state evidence for host-only operations remain open; see [final release-readiness audit](final-release-readiness-audit.md).
...
460. [FINAL][Core §49][UI §§49–50][AUDITED; gate open] The core audit records 8 PASS, 7 PARTIAL, and 60 OPEN criteria; the UI audit records 0 PASS, 6 PARTIAL, and 61 OPEN. Tasks 452–453 and 455–458 retain implementation, evidence, or release-gate gaps. See [final release-readiness audit](final-release-readiness-audit.md), [acceptance-evidence-audit.md](acceptance-evidence-audit.md), and [ui-acceptance-evidence-audit.md](ui-acceptance-evidence-audit.md).
