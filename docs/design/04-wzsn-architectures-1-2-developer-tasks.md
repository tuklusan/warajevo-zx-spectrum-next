...
454. [FINAL][Core §§34,35][AUDITED; gate open] The configured hosted runner/compiler matrix is incomplete: it omits mandatory Linux x86-64 and Linux AArch64 GCC/Clang groups. See [final release-readiness audit](final-release-readiness-audit.md).
