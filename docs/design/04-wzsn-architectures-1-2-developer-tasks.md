...
458. [FINAL][Core §§30,55][UI §§4,40,46][AUDITED; gate open] Shared command-boundary and wrong-thread mutation acceptance remain unproven; see [final release-readiness audit](final-release-readiness-audit.md).
