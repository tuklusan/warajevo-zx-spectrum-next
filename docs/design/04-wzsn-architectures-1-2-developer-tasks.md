...
459. [FINAL][Core §§5,6,26,45][IN PROGRESS] Added a hosted dependency-boundary check with forbidden-include negative controls and a pinned proof artifact in `.github/workflows/core-dependency-boundary.yml`; close after the main-branch run passes and its proof is inspected.
