...
#define WZ_STATE_EXTENSION_CAPACITY 1024u
#define WZ_STATE_SNAPSHOT_CAPACITY (65536u + 125u + WZ_STATE_EXTENSION_CAPACITY)
#define WZ_STATE_MACHINE_MEMORY_OFFSET 125u
#define WZ_STATE_MACHINE_LENGTH \
    (WZ_STATE_MACHINE_MEMORY_OFFSET + 65536u + WZ_STATE_EXTENSION_CAPACITY)
...
#define WZ_Z80_128K_PAGE_COUNT 8u
...
#define WZ_Z80_128K_V2_LENGTH (WZ_Z80_V2_HEADER_LENGTH + \
                               (WZ_Z80_128K_PAGE_COUNT * \
                                (3u + WZ_Z80_V2_PAGE_SIZE)))
